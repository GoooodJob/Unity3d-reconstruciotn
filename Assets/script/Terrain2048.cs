...
public class Terrain2048 : MonoBehaviour
{
    int width = 2048;
    int height = 2048; 
    int geo_st = 0;
    ...
    public void GenerateBig()
    {
        ...
        terrain1.GetComponent<Terrain>().enabled = true;
    ...
    private TerrainData GenerateTerrain(TerrainData terrainData)
    {
        ...
        terrainData.size = new Vector3(width, FileControllor.depth, height);
        ...
        using (StreamReader sr = FileControllor.info.OpenText())
        {
            ...
            while ((s = sr.ReadLine()) != null && index < width)
            {
                ...
                if (index == 0)
                {
                    ...
                    geo_ex = (geo - FileControllor.mingeo) * 100;
                    geoint = (int)geo_ex;
                    geo_2 = geoint;
